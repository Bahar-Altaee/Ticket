                ...
                {{ csrf_field() }}
                    ...
                    <div class="card" style="height: 177.609px;">
                        <div class="card-header">
                            <h4 class="card-title">Add New Third-Party ONT</h4>
                        </div>
      ...
      <div class="modal fade text-left" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel35"> Add New Third-Party ONT</h3>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close" data-bs-original-title="" title=""></button>

                </div>

                <form action="{{ route('activatethird') }}" method="POST">
                    @csrf
       ...
       <select name="oltid"class="select2 form-control" required>
             ...
             <option value="NTWK-BELOLT01">BELOLT1</option>
                                                        ...
                                                        <label for="exampleInputEmail1">ONT Vendor</label>
                                 <select value="" class="select form-control" id="vendor" name="vendor" required>
                                    <option value="34">ZTE</option>
                                    <option value="31">Window World 1G</option>
                                    <option value="32">Window World 5G</option>
                                    <option value="33">Fiber Home</option>
                                    <option value="35">Tenda HG1</option>
