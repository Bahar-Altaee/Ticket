...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click"
    ...
    <div class="app-content content">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">ZTE</a>
                                </li>
                                </li>
                            </ol>
                        </div>
        ...
        <div class="content-body">
            ...
            <form action="{{ route('ztereplacediscover') }}" method="POST">

                {{ csrf_field() }}

                    <div class="card" style="height: 177.609px;">
                        <div class="card-header">
                            <h4 class="card-title">Add New ZTE ONT Without SAS</h4>
                        </div>
  ...
  <div class="modal fade text-left" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('ztereplace') }}" method="POST">
                    {{method_field('POST')}}
                    @csrf
